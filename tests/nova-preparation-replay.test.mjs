...
test('locked sound waits for ended, not a fixed timeout, and gates play',()=>{
 ...
 const ctx=vm.createContext({Audio,setTimeout:fn=>{timers.push(fn);return 1;},clearTimeout:()=>{},updateAutoUi:()=>{},soundOutputVolume:(src,x)=>x,prepareCharacterVoiceAudio(){},isCompleteTrialLocked:()=>false});
