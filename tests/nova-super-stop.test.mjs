...
test('super NOVA landing uses new sound once at third stop including reverse freeze',()=>{
 for(const reverse of [false,true]){
  ...
  assert.deepEqual(sounds,['normal','normal','assets/media/nova/super-nova-stop.wav']);
 }
});
