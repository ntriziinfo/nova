...
globalThis.NovaBalance=(()=>{
 // Measured estimates: docs/role128-report.md (rare-role CZ and common 800G ceiling).
 // +10,000pt stop or 30,000G cutoff; S1-5 1,000 trials each, S6 3,000 holdouts.
 const targets=[0.955124,0.979594,1.005842,1.042418,1.078051,1.138476];
