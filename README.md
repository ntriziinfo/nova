最新の抽選変更は [引き戻しの成立役による設定確定（v142）](docs/comeback142.md)。ベル復活は奇数設定、リプレイ復活は偶数設定、ハズレ復活は設定4～6に限定。引き戻し中だけベルを全設定1/50にし、レア役復活100%を含めた5G合計の復活率20%を維持しました。変更後の機械割は未再集計です。
