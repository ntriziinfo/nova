最新の抽選変更は [引き戻し中のレア役増加・奇偶確定を1%へ（v143）](docs/comeback143.md)。引き戻し中だけレア役合算を約1/24へ上げ、ベル復活（奇数）・リプレイ復活（偶数）をゾーン1回あたり各1%に調整。レア役復活100%、ハズレ復活の設定4～6確定、5G合計の復活率20%は維持しました。変更後の機械割は未再集計です。
