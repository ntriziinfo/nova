...
for(const setting of [1,6]){
 loadModel('..',false);const plain=simulate(setting,30000,126999000+setting,{rng:'xoshiro128',completeLimitPt:10000});
 ...
 const cached=simulate(setting,30000,126999000+setting,{rng:'xoshiro128',completeLimitPt:10000});
...
fs.writeFileSync('research/start126/parity.json',JSON.stringify(results,null,2)+'\n');console.log(JSON.stringify(results));
