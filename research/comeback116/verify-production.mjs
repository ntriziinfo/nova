...
const targets=process.argv.slice(2).map(Number),output='docs/comeback116-production-parity.json';
...
for(const {setting,file}of manifest.jobs.filter(r=>!targets.length||targets.includes(r.setting))){
