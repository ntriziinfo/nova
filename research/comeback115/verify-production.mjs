...
const targets=process.argv.slice(2).map(Number),output='docs/comeback115-production-parity.json';
...
for(const {setting,file}of manifest.sources.filter(r=>!targets.length||targets.includes(r.setting))){
