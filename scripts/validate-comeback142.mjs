...
for(let setting=1;setting<=6;setting++){
 ...
 const rng=xoshiro128(1420000000+setting),base=a.beginComeback(a.enter({setting},()=>0));
 let games=0;
 ...
 const smoke=simulate(setting,30000,1421000000+setting,{rng:'xoshiro128',exactGames:true,stopAtComplete:false});
...
fs.writeFileSync('docs/comeback142-validation.json',JSON.stringify({version:142,seedBase:1420000000,sourceHashes,settings},null,2)+'\n');
