...
export function simulate(setting,scale,games=1000000,seed=1234567,options={}){
 ...
 try{while(count<games){
  ...
  else if(t.direct)flow=(a.enterInitial||a.enter)(c,rng);
