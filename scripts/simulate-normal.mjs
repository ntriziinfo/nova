...
export function simulate(setting,scale,games=1000000,seed=1234567){
 ...
 return {setting,scale,bias:NovaArt.biasFor(setting),bonusSpecial:NovaArt.bonusSpecialFor(setting),games:count,rtp:paid/(count*3),freezes,ceilings,release,bonusNet:bonusP/bonusG-3};
}
