...
for(let setting=1;setting<=6;setting++){
 const results=[];for(let k=0;k<10;k++)results.push(simulate(setting,NovaBalance.profile(setting).scale,500000,({5:49000031,6:39000031}[setting]||19000031)+k*197891+setting));
